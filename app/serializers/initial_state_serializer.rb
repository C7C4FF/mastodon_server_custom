  ...
  def default_meta_store
    {
      ...
      locale: I18n.locale,
      background: instance_presenter.background&.file&.url('2560'),
      background_light: (instance_presenter.background_light || instance_presenter.background)&.file&.url('2560'),
      background_dark: (instance_presenter.background_dark || instance_presenter.background)&.file&.url('2560'),
      logo: instance_presenter.logo&.file&.url('display'),
      logo_light: (instance_presenter.logo_light || instance_presenter.logo)&.file&.url('display'),
      logo_dark: (instance_presenter.logo_dark || instance_presenter.logo)&.file&.url('display'),
